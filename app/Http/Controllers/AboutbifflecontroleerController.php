...
use App\Models\Aboutbifflecontroleer;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class AboutbifflecontroleerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'aboutbifflecontroleer';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Aboutbifflecontroleer();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'aboutbifflecontroleer',
	...
	public static function display(  )
	{
		...
		$model  = new Aboutbifflecontroleer();
		$info = $model::makeInfo('aboutbifflecontroleer');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('aboutbifflecontroleer.public.view',$data);			
			}			
		} 
		else {
			...
			return view('aboutbifflecontroleer.public.index',$data);	
		}
