...
use App\Models\Achievementcontroller;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class AchievementcontrollerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'achievementcontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Achievementcontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'achievementcontroller',
	...
	public static function display(  )
	{
		...
		$model  = new Achievementcontroller();
		$info = $model::makeInfo('achievementcontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('achievementcontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('achievementcontroller.public.index',$data);	
		}
