...
use App\Models\Bifflservices;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BifflservicesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'bifflservices';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Bifflservices();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'bifflservices',
	...
	public static function display(  )
	{
		...
		$model  = new Bifflservices();
		$info = $model::makeInfo('bifflservices');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bifflservices.public.view',$data);			
			}			
		} 
		else {
			...
			return view('bifflservices.public.index',$data);	
		}
