...
class BlogcategoryadminController extends Controller {
	...
	public $module = 'blogcategoryadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Blogcategoryadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'blogcategoryadmin',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('blogcategoryadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('blogcategoryadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('blogcategoryadmin.public.index',$data);	
		}
