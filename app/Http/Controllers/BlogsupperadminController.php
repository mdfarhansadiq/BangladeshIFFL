...
use App\Models\Blogsupperadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BlogsupperadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'blogsupperadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Blogsupperadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'blogsupperadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Blogsupperadmin();
		$info = $model::makeInfo('blogsupperadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('blogsupperadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('blogsupperadmin.public.index',$data);	
		}
