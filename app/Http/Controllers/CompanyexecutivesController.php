...
use App\Models\Companyexecutives;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class CompanyexecutivesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'companyexecutives';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Companyexecutives();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'companyexecutives',
	...
	public static function display(  )
	{
		...
		$model  = new Companyexecutives();
		$info = $model::makeInfo('companyexecutives');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('companyexecutives.public.view',$data);			
			}			
		} 
		else {
			...
			return view('companyexecutives.public.index',$data);	
		}
