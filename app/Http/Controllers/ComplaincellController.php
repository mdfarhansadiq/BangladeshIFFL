...
use App\Models\Complaincell;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ComplaincellController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'complaincell';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Complaincell();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'complaincell',
	...
	public static function display(  )
	{
		...
		$model  = new Complaincell();
		$info = $model::makeInfo('complaincell');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('complaincell.public.view',$data);			
			}			
		} 
		else {
			...
			return view('complaincell.public.index',$data);	
		}
