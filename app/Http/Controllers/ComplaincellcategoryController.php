...
use App\Models\Complaincellcategory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ComplaincellcategoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'complaincellcategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Complaincellcategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'complaincellcategory',
	...
	public static function display(  )
	{
		...
		$model  = new Complaincellcategory();
		$info = $model::makeInfo('complaincellcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('complaincellcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('complaincellcategory.public.index',$data);	
		}
