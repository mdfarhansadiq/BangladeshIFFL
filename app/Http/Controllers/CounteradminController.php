...
class CounteradminController extends Controller {
	...
	public $module = 'counteradmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Counteradmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'counteradmin',
	...
	public static function display(  )
	{
		...
		$model  = new Counteradmin();
		$info = $model::makeInfo('counteradmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('counteradmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('counteradmin.public.index',$data);	
		}
