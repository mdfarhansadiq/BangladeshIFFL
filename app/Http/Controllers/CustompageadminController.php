...
use App\Models\Custompageadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class CustompageadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'custompageadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Custompageadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'custompageadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Custompageadmin();
		$info = $model::makeInfo('custompageadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('custompageadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('custompageadmin.public.index',$data);	
		}
