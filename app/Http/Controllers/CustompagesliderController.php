...
use App\Models\Custompageslider;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class CustompagesliderController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'custompageslider';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Custompageslider();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'custompageslider',
	...
	public static function display(  )
	{
		...
		$model  = new Custompageslider();
		$info = $model::makeInfo('custompageslider');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('custompageslider.public.view',$data);			
			}			
		} 
		else {
			...
			return view('custompageslider.public.index',$data);	
		}
