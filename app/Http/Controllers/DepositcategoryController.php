...
class DepositcategoryController extends Controller {
	...
	public $module = 'depositcategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Depositcategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'depositcategory',
	...
	public static function display(  )
	{
		...
		$model  = new Depositcategory();
		$info = $model::makeInfo('depositcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('depositcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('depositcategory.public.index',$data);	
		}
