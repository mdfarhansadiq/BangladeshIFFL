...
use App\Models\Depositrequestcontroller;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DepositrequestcontrollerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'depositrequestcontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Depositrequestcontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'depositrequestcontroller',
	...
	public static function display(  )
	{
		...
		$model  = new Depositrequestcontroller();
		$info = $model::makeInfo('depositrequestcontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('depositrequestcontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('depositrequestcontroller.public.index',$data);	
		}
