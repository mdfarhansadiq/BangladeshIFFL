...
use App\Models\Disclosureadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DisclosureadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'disclosureadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Disclosureadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'disclosureadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Disclosureadmin();
		$info = $model::makeInfo('disclosureadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('disclosureadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('disclosureadmin.public.index',$data);	
		}
