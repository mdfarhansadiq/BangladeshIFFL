...
class DisclosurecategoryController extends Controller {
	...
	public $module = 'disclosurecategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Disclosurecategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'disclosurecategory',
	...
	public static function display(  )
	{
		...
		$model  = new Disclosurecategory();
		$info = $model::makeInfo('disclosurecategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('disclosurecategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('disclosurecategory.public.index',$data);	
		}
