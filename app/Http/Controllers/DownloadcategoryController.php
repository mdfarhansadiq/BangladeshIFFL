...
class DownloadcategoryController extends Controller {
	...
	public $module = 'downloadcategory';
	static $per_page	= '50';
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('downloadcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('downloadcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('downloadcategory.public.index',$data);	
		}
