...
class DownloaddocumentController extends Controller {
	...
	public $module = 'downloaddocument';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Downloaddocument();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'downloaddocument',
	...
	public static function display(  )
	{
		...
		$model  = new Downloaddocument();
		$info = $model::makeInfo('downloaddocument');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('downloaddocument.public.view',$data);			
			}			
		} 
		else {
			...
			return view('downloaddocument.public.index',$data);	
		}
