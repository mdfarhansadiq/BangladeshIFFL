...
class EmailtemplateController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('emailtemplate');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('emailtemplate.public.view',$data);			
			}			
		} 
		else {
			...
			return view('emailtemplate.public.index',$data);	
		}
