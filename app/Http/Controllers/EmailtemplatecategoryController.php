...
class EmailtemplatecategoryController extends Controller {
	...
	public $module = 'emailtemplatecategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Emailtemplatecategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'emailtemplatecategory',
	...
	public static function display(  )
	{
		...
		$model  = new Emailtemplatecategory();
		$info = $model::makeInfo('emailtemplatecategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('emailtemplatecategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('emailtemplatecategory.public.index',$data);	
		}
