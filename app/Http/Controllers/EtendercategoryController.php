...
use App\Models\Etendercategory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class EtendercategoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'etendercategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Etendercategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'etendercategory',
	...
	public static function display(  )
	{
		...
		$model  = new Etendercategory();
		$info = $model::makeInfo('etendercategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('etendercategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('etendercategory.public.index',$data);	
		}
