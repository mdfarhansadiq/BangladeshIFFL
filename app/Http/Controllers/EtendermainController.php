...
use App\Models\Etendermain;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class EtendermainController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'etendermain';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Etendermain();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'etendermain',
	...
	public static function display(  )
	{
		...
		$model  = new Etendermain();
		$info = $model::makeInfo('etendermain');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('etendermain.public.view',$data);			
			}			
		} 
		else {
			...
			return view('etendermain.public.index',$data);	
		}
