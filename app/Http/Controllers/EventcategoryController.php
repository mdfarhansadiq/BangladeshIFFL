...
class EventcategoryController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('eventcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('eventcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('eventcategory.public.index',$data);	
		}
