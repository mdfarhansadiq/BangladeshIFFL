...
class FaqcategoryController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('faqcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('faqcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('faqcategory.public.index',$data);	
		}
