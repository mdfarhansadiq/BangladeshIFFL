...
// 	}
	...
	function store( Request $request  )
	{
    	...
    	$image_name = $filename.'.'.$image_name2;
			...
			default:
				...
				if ($validator->passes()) 
				{
					...
					if($image_name){
    					...
    					DB::table('file_gallery')->where('id', $id)->update([
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('filegallery');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('filegallery.public.view',$data);			
			}			
		} 
		else {
			...
			return view('filegallery.public.index',$data);	
		}
