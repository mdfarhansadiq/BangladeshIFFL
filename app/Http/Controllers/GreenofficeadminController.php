...
use App\Models\Greenofficeadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class GreenofficeadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'greenofficeadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Greenofficeadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'greenofficeadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Greenofficeadmin();
		$info = $model::makeInfo('greenofficeadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('greenofficeadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('greenofficeadmin.public.index',$data);	
		}
