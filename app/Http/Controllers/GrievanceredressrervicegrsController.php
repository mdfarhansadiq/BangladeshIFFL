...
use App\Models\Grievanceredressrervicegrs;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class GrievanceredressrervicegrsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'grievanceredressrervicegrs';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Grievanceredressrervicegrs();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'grievanceredressrervicegrs',
	...
	public static function display(  )
	{
		...
		$model  = new Grievanceredressrervicegrs();
		$info = $model::makeInfo('grievanceredressrervicegrs');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('grievanceredressrervicegrs.public.view',$data);			
			}			
		} 
		else {
			...
			return view('grievanceredressrervicegrs.public.index',$data);	
		}
