...
use App\Models\Headersocialmedia;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class HeadersocialmediaController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'headersocialmedia';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Headersocialmedia();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'headersocialmedia',
	...
	public static function display(  )
	{
		...
		$model  = new Headersocialmedia();
		$info = $model::makeInfo('headersocialmedia');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('headersocialmedia.public.view',$data);			
			}			
		} 
		else {
			...
			return view('headersocialmedia.public.index',$data);	
		}
