...
use App\Models\Headlineadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class HeadlineadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'headlineadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Headlineadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'headlineadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Headlineadmin();
		$info = $model::makeInfo('headlineadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('headlineadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('headlineadmin.public.index',$data);	
		}
