...
class HomesliderController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('homeslider');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('homeslider.public.view',$data);			
			}			
		} 
		else {
			...
			return view('homeslider.public.index',$data);	
		}
