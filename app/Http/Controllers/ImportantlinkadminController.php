...
use App\Models\Importantlinkadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ImportantlinkadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'importantlinkadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Importantlinkadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'importantlinkadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Importantlinkadmin();
		$info = $model::makeInfo('importantlinkadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('importantlinkadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('importantlinkadmin.public.index',$data);	
		}
