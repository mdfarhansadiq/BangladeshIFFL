...
class LoancategoryController extends Controller {
	...
	public $module = 'loancategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Loancategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'loancategory',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('loancategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('loancategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('loancategory.public.index',$data);	
		}
