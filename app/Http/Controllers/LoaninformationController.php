...
class LoaninformationController extends Controller {
	...
	public $module = 'loaninformation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Loaninformation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'loaninformation',
	...
	public static function display(  )
	{
		...
		$model  = new Loaninformation();
		$info = $model::makeInfo('loaninformation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('loaninformation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('loaninformation.public.index',$data);	
		}
