...
class LoanrequestController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('loanrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('loanrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('loanrequest.public.index',$data);	
		}
