...
class NewsletteradminController extends Controller {
	...
	public $module = 'newsletteradmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Newsletteradmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'newsletteradmin',
	...
	public static function display(  )
	{
		...
		$model  = new Newsletteradmin();
		$info = $model::makeInfo('newsletteradmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('newsletteradmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('newsletteradmin.public.index',$data);	
		}
