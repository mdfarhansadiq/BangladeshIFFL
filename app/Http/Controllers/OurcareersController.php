...
use App\Models\Ourcareers;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurcareersController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourcareers';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourcareers();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourcareers',
	...
	public static function display(  )
	{
		...
		$model  = new Ourcareers();
		$info = $model::makeInfo('ourcareers');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourcareers.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourcareers.public.index',$data);	
		}
