...
use App\Models\Ourpartnersadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurpartnersadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourpartnersadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourpartnersadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourpartnersadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Ourpartnersadmin();
		$info = $model::makeInfo('ourpartnersadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourpartnersadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourpartnersadmin.public.index',$data);	
		}
