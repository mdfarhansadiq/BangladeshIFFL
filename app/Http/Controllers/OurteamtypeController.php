...
use App\Models\Ourteamtype;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurteamtypeController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourteamtype';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourteamtype();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourteamtype',
	...
	public static function display(  )
	{
		...
		$model  = new Ourteamtype();
		$info = $model::makeInfo('ourteamtype');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourteamtype.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourteamtype.public.index',$data);	
		}
