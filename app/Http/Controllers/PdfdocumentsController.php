...
class PdfdocumentsController extends Controller {
	...
	public $module = 'pdfdocuments';
	static $per_page	= '50';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Pdfdocuments();

		$this->info = $this->model->makeInfo( $this->module);
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'pdfdocuments',
	...
	public static function display(  )
	{
		...
		$model  = new Pdfdocuments();
		$info = $model::makeInfo('pdfdocuments');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('pdfdocuments.public.view',$data);
			}
		}
		else {
			...
			return view('pdfdocuments.public.index',$data);
		}
