...
use App\Models\Policyandguidelinesadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PolicyandguidelinesadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'policyandguidelinesadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Policyandguidelinesadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'policyandguidelinesadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Policyandguidelinesadmin();
		$info = $model::makeInfo('policyandguidelinesadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('policyandguidelinesadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('policyandguidelinesadmin.public.index',$data);	
		}
