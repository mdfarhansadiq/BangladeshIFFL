...
use App\Models\Policyandguidelinescategory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PolicyandguidelinescategoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'policyandguidelinescategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Policyandguidelinescategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'policyandguidelinescategory',
	...
	public static function display(  )
	{
		...
		$model  = new Policyandguidelinescategory();
		$info = $model::makeInfo('policyandguidelinescategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('policyandguidelinescategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('policyandguidelinescategory.public.index',$data);	
		}
