...
class PopupsliderController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'popupslider';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Popupslider();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'popupslider',
	...
	public static function display(  )
	{
		...
		$model  = new Popupslider();
		$info = $model::makeInfo('popupslider');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('popupslider.public.view',$data);			
			}			
		} 
		else {
			...
			return view('popupslider.public.index',$data);	
		}
