...
class PortfoliocategoryController extends Controller {
	...
	public $module = 'portfoliocategory';
	static $per_page	= '50';
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('portfoliocategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('portfoliocategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('portfoliocategory.public.index',$data);	
		}
