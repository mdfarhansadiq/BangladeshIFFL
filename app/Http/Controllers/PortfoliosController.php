...
class PortfoliosController extends Controller {
	...
	public $module = 'portfolios';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Portfolios();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'portfolios',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('portfolios');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('portfolios.public.view',$data);			
			}			
		} 
		else {
			...
			return view('portfolios.public.index',$data);	
		}
