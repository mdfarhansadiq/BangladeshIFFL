...
use App\Models\Projectcategoryadmin;
...
class ProjectcategoryadminController extends Controller {
	...
	public $module = 'projectcategoryadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Projectcategoryadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'projectcategoryadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Projectcategoryadmin();
		$info = $model::makeInfo('projectcategoryadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('projectcategoryadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('projectcategoryadmin.public.index',$data);	
		}
