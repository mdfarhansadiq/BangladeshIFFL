...
use App\Models\Projectscontrollermain;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ProjectscontrollermainController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'projectscontrollermain';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Projectscontrollermain();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'projectscontrollermain',
	...
	public static function display(  )
	{
		...
		$model  = new Projectscontrollermain();
		$info = $model::makeInfo('projectscontrollermain');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('projectscontrollermain.public.view',$data);			
			}			
		} 
		else {
			...
			return view('projectscontrollermain.public.index',$data);	
		}
