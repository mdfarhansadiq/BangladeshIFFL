...
use App\Models\Reportcategoryadmin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ReportcategoryadminController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'reportcategoryadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Reportcategoryadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'reportcategoryadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Reportcategoryadmin();
		$info = $model::makeInfo('reportcategoryadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('reportcategoryadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('reportcategoryadmin.public.index',$data);	
		}
