...
class ReportsadminController extends Controller {
	...
	public $module = 'reportsadmin';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Reportsadmin();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'reportsadmin',
	...
	public static function display(  )
	{
		...
		$model  = new Reportsadmin();
		$info = $model::makeInfo('reportsadmin');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('reportsadmin.public.view',$data);			
			}			
		} 
		else {
			...
			return view('reportsadmin.public.index',$data);	
		}
