...
use App\Models\Strategicpartners;
...
class StrategicpartnersController extends Controller {
	...
	public $module = 'strategicpartners';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Strategicpartners();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'strategicpartners',
	...
	public static function display(  )
	{
		...
		$model  = new Strategicpartners();
		$info = $model::makeInfo('strategicpartners');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('strategicpartners.public.view',$data);			
			}			
		} 
		else {
			...
			return view('strategicpartners.public.index',$data);	
		}
