...
class WebsitedesignController extends Controller {
	...
	public $module = 'websitedesign';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Websitedesign();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'websitedesign',
	...
	public static function display(  )
	{
		...
		$model  = new Websitedesign();
		$info = $model::makeInfo('websitedesign');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('websitedesign.public.view',$data);			
			}			
		} 
		else {
			...
			return view('websitedesign.public.index',$data);	
		}
