...
class WebsitesettingController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('websitesetting');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('websitesetting.public.view',$data);			
			}			
		} 
		else {
			...
			return view('websitesetting.public.index',$data);	
		}
