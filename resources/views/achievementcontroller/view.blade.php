	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Institution', (isset($fields['institution']['language'])? $fields['institution']['language'] : array())) }}</td>
						<td>{{ $row->institution}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Providoor', (isset($fields['providoor']['language'])? $fields['providoor']['language'] : array())) }}</td>
						<td>{{ $row->providoor}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Cause', (isset($fields['cause']['language'])? $fields['cause']['language'] : array())) }}</td>
						<td>{{ $row->cause}} </td>
