		 ...
		 {!! Form::open(array('url'=>'greenofficeadmin', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Green Office</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="document-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["document"],"/uploads/files") !!}
						</div>
