...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'imagegallerycontroller?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Image Gallery</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  </div> {!! Form::hidden('category', $row['category']) !!}					
									  <div class="form-group row  " >
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/images/gallery") !!}
									  ...
									  </div> {!! Form::hidden('route', $row['route']) !!}{!! Form::hidden('add_info1', $row['add_info1']) !!}{!! Form::hidden('add_info2', $row['add_info2']) !!}{!! Form::hidden('add_info3', $row['add_info3']) !!}					
									  <div class="form-group row  " >
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("imagegallerycontroller/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
