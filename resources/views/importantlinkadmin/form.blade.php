...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'importantlinkadmin?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Important Link</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  </div> {!! Form::hidden('description', $row['description']) !!}					
									  <div class="form-group row  " >
					...
					$category_opt = array( 'external' => 'External Link' ,  'internal' => 'Internal Link' , ); ?>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("importantlinkadmin/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
