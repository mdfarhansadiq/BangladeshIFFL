...
@endif
                ...
                <div class="footer-content md-pb-64 sm-pt-48" id="internal_link">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-5 col-lg-5 footer-widget" id="internal_link_border">
                            <div class="col-12 col-sm-12 col-lg-12 col-md-12 internal_liink_title"> <h4 class="widget-title">Internal Links</h4></div>
                                        ...
                                        <li>
                                            ...
                                            @foreach($important_link as $data)
                                                @if($data->category == 'internal' && $x < $count)
                                                    <div class="desc"> <a href="{{ $data->link }}">{{ $data->title }}</a> </div>
                                                    @php
                                                        $x+=1;
                                                    @endphp
                                                @endif
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 footer-widget text-right">
                            ...
                            <ul class="address-widget">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        Fax: <a href="fax:{{ $website_setting->pinterest }}">{{ $website_setting->pinterest }}</a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <!-- <i class="flaticon-email"></i> -->
                                    <div class="desc">
                                        E-mail: <a href="mailto:{{ $website_setting->email }}">{{ $website_setting->email }}</a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <!-- <i class="flaticon-call"></i> -->
                                    <div class="desc">
                                        Bangladesh Bank Hotline: <a href="tel:{{$website_setting->updated_at}}">{{ $website_setting->updated_at }}</a>
                                    </div>
                                </li>
                            </ul>
        ...
        <div class="copywrite">
        © 2021 Bangladesh Infrastructure Finance Fund Limited (BIFFL). All Rights Reserved. Designed by <a href="https://www.vmsl.com.bd">VMSL</a>
        </div>
