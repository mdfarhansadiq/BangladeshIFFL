...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'ourpartnersadmin?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/images/partner") !!}
						</div>
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  </div> {!! Form::hidden('description', $row['description']) !!}{!! Form::hidden('add_info1', $row['add_info1']) !!}{!! Form::hidden('add_info2', $row['add_info2']) !!}					
									  <div class="form-group row  " >
										<label for="Serial Number" class=" control-label col-md-4 text-left"> Serial Number <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  <input  type='text' name='serial_number' id='serial_number' value='{{ $row['serial_number'] }}' 
						required     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("ourpartnersadmin/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
