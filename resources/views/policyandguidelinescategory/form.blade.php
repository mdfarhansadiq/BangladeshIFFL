...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'policyandguidelinescategory?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Policy and Guidelines Category</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Parent Category" class=" control-label col-md-4 text-left"> Parent Category </label>
										<div class="col-md-6">
										  <select name='image' rows='5' id='image' class='select2 '   ></select> 
										 </div> 
										 <div class="col-md-2">
						...
						<div class="banner-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["banner"],"/uploads/images/guidelines") !!}
						</div>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#image").jCombo("{!! url('policyandguidelinescategory/comboselect?filter=vsml_guidelines_category:id:title') !!}",
		{  selected_value : '{{ $row["image"] }}' });
		 	
		 	 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("policyandguidelinescategory/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
