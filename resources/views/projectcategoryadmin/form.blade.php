...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'projectcategoryadmin?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Project Category</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="banner-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["banner"],"/uploads/images/project") !!}
						</div>
									  ...
									  </div> {!! Form::hidden('description', $row['description']) !!}{!! Form::hidden('serial', $row['serial']) !!}					
									  <div class="form-group row  " >
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("projectcategoryadmin/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
